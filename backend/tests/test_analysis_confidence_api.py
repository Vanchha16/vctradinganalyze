...
def test_get_confidence_requires_authentication(client: TestClient, session: Session) -> None:
    ...
    response = client.get("/api/v1/analysis/confidence/XAUUSD", params={"timeframe": "h1"})
