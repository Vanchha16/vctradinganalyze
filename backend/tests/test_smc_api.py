...
def test_get_smc_analysis_requires_authentication(client: TestClient, session: Session) -> None:
    ...
    response = client.get("/api/v1/analysis/smc/XAUUSD", params={"timeframe": "h1"})
