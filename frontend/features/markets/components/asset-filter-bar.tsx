  ...
  return (
    <FilterBar>
      <FilterField label="Search">
        <div className="focus-within:shadow-glow flex items-center gap-2 rounded-lg border border-border bg-surface px-3 py-2 transition-all focus-within:border-primary/40 md:w-80">
